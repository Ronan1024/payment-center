...
//        }
    ...
    public Object refund() {
        ...
        //原消费订单
        map.put("orgRespTraceNum", "20250308191103208501135259");
        ...
        Long orderAmount = refundAmount + promotionAmount - longValue;
        map.put("orderAmount", 1000);

        sepRefundInfo.put("orderAmount", 997);
        // 需要配置平台抽拥比例  不能大于签约时的平台抽拥比例

        sepRefundInfo.put("couponAmount", 12);
        sepRefundInfo.put("cnlRefundAmount", 1000);
//         下单付款用户id
        sepRefundInfo.put("signNum", "1894259806383198208");
